...
<?php if ($this->config["manualapproval"]): ?>
  <div class="alert alert-info">
    <?php echo e("We are currently manually approving links. As soon as the link is approved, you will be able to start using it.") ?>
  </div>
<?php endif ?>
